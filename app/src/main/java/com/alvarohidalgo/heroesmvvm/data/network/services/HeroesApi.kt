...
interface HeroesApi {
    ...
    fun getPrincipalHeroes(@Query("nameStartsWith") name: String? = null): Deferred<ApiResponse<HeroeDTO>>

    @GET("/v1/public/characters/{characterId}")
    fun getHeroeById(@Path("character_id") id: Int): Deferred<ApiResponse<HeroeDTO>>
